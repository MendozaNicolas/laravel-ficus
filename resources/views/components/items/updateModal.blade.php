                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control" name="name"
                            id="item-update-name" placeholder="name">
                        <label for="name">Name</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="text" class="form-control" name="description"
                            id="item-update-description" placeholder="description">
                        <label for="description">Description</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input autocomplete="off" type="number" class="form-control" name="quantity"
                            id="item-update-quantity" placeholder="quantity" min="1">
