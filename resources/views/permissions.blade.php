...
@section('content')
    <div class="sidebar-container">
        ...
        <section>
            <x-permissions.addModal />
            <x-permissions.readModal />
            <x-permissions.updateModal />

            <div class="container">
                <div class="ms-5 my-3">
                    <h2 class="d-inline">Permission Management</h2>
                        ...
                        <tbody>
                            @foreach ($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn"
                                            onclick="readPermissionModal('{{ $permission->name }}', '{{ $permission->guard_name }}')"
                                        ...
                                        <button class="btn"
                                            onclick="updatePermissionModal('{{ $permission->id }}', '{{ $permission->name }}', '{{ $permission->guard_name }}')"
                                        ...
                                        <form action="/permissions/delete" method="POST" class="d-inline">
                                            @csrf
                                            <input hidden type="number" name="id" value="{{ $permission->id }}">
